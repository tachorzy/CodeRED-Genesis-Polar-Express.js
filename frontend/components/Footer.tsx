...
const Footer = () => {
    ...
    return(
        <div className="grid grid-cols-3 bg-violet-900 w-full">
            <div>
                <div className={" flex flex-col md:flex-row bg-violet-900 h-full md:h-52 py-8 md:pl-28 max-md:px-14 gap-x-24"}>
                    <span className="md:ml-12 text-violet-200 max-md:mb-6">
                ...
                <div className={"bg-violet-900 md:pl-28 pl-12 pb-4"}>
            ...
            <div className="flex flex-row col-span-3 h-full ml-12 w-full md:pl-28">
                <div className="flex flex-row">
                    <h1 className={"text-8xl font-bold text-violet-800"}>These b*tches<br/>could never.</h1>
                    <div className="flex flex-row flex-wrap gap-x-0 gap-y-0 select-none w-[25rem] ml-4 mt-16 scale-[70%]">
